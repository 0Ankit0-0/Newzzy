...
export class Home extends Component {
    ...
    updateNews = async () => {
        ...
        // ✅ Updated URL to use top-headlines instead of wsj.com domain
        const url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=a747e705b6344eaba5f78c91acad30c4&page=${page}&pageSize=${pageSize}`;
